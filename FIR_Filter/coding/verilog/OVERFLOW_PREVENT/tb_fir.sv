// ============================================================================
// tb_fir.v — Testbench for fir_basic (100-tap symmetric FIR)
// ============================================================================
`timescale 1ns / 1ps
...
module tb_fir;
    ...
    initial begin
        ...
        // Feed a single 1 followed by zeros; output should be the coefficients
        @(posedge clk);
        din       = 16'sd1;
        din_valid = 1;
        @(posedge clk);
        ...
        // Clock enough cycles to flush the full impulse response
