// ============================================================================
// fir_basic.sv — Direct-Form FIR Filter (symmetric, linear phase)
//                OVERFLOW CONTROL variant: true 32-bit internal tree
// ============================================================================
// Same coefficients and architecture as OVERFLOW_PREVENT/fir_basic.sv.
// Internal adder tree operates at 32 bits (W_OUT) with two's complement
// wrap-around.  No saturation logic — correct for all bandlimited signals
// whose final sum fits within 32 signed bits.
//
// 192-tap, Q20, 21-bit signed coefficients.
//   Passband ripple: 0.50 dB | Stopband atten: 80.1 dB
...
module fir_basic #(
    ...
    parameter W_OUT     = 32        // output width (also internal tree width)
)(
    input  wire                    clk,
    input  wire                    rst_n,
