...
//                                 Adder Trees
//                                 OVERFLOW CONTROL variant: true 32-bit
//                                 internal tree
// ============================================================================
// Same datapath as fir_parallel_L3.sv but with PIPELINE REGISTERS at every
// stage of each output channel's binary adder tree.
//
// Pipeline latency: 8 extra clock cycles.
...
module fir_parallel_L3_pipelined #(
    ...
    // =====================================================================
    //  Combinational pre-adds and multiplies
    // =====================================================================
    ...
    // =====================================================================
    //  PIPELINED BINARY ADDER TREES (32-bit, two's complement wrap)
    // =====================================================================
