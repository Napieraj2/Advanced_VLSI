// ============================================================================
// fir_parallel_L2.sv — L=2 Polyphase Parallel FIR Filter
//                      OVERFLOW CONTROL variant: true 32-bit internal tree
// ============================================================================
// Processes TWO input samples per clock, producing TWO outputs.
...
module fir_parallel_L2 #(
    ...
    input  wire                    clk,
    input  wire                    rst_n,
    input  wire signed [W_IN-1:0]  din_0,
    input  wire signed [W_IN-1:0]  din_1,
    input  wire                    din_valid,
    output reg  signed [W_OUT-1:0] dout_0,
    output reg  signed [W_OUT-1:0] dout_1,
    ...
    // ----- Even polyphase coefficient ROM -----
    ...
    localparam TREE_STAGES = $clog2(HALF_TAPS);
    localparam N_PAD       = 1 << TREE_STAGES;
